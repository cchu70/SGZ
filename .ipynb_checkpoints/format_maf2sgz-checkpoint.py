...
def format_maf2sgz(sample_id, maf_fn):
    ...
    new_maf_fn = '{}.maf2sgz.tsv'.format(sample_id)
...
def parse_args():
    ...
    parser.add_argument('--sample_id', type=str,
                        help='sample id')
    parser.add_argument('--put_som_annot_maf', type=str,
                        help='Path to maf with "putiative_somatic" column annotation')
...
def main():
    ...
    new_maf_fn = format_maf2sgz(
        sample_id=args.sample_id, 
        maf_fn=args.put_som_annot_maf, 
    )
